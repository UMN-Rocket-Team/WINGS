...
const DefaultModalLayout: ParentComponent<DefaultModalLayoutProps> = (props): JSX.Element => {   
    return (
        <div class="absolute z-10 inset-0 flex" tabIndex={-1} 
            ...
            onClick={() => props.close()}>
            <div class="flex flex-col items-center m-auto max-h-[75%] max-w-full w-[691.2px] p-4 gap-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-gray-200 dark:border-gray-700 relative"
