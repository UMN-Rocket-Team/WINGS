...
const Homepage: Component = () => {
    ...
    const loadFlight = async () => {
        ...
        readTextFile(selectedFilePath as string)
            ...
            .catch((err) => showModal<ErrorModalProps, unknown>(ErrorModal, {
    ...
    const openDisplaySetup = async () => {
        ...
        try {
            ...
            showModal<ErrorModalProps, unknown>(ErrorModal, {
                error: "Failed to Load Saved Displays Setup",
                description: "Invalid JSON data." + err,
            });
        }
    }
        ...
        <div class="flex flex-col flex-grow p-4 gap-4 dark:bg-dark-700">
            ...
            <div class="flex w-full justify-center relative">
                <div class="flex justify-center gap-2 items-center">
                    ...
                    <button
                        class="p-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-900 hover:dark:bg-gray-800 dark:text-white rounded-lg"
                        onClick={() => showModal<ErrorModalProps, unknown>(Credits, {})}>Credits
                    </button>
                </div>
            </div>
        </div>
