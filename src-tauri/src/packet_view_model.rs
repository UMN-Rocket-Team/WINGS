...
impl PacketViewModel{
    pub fn to_packet_structure(&self, id: usize) -> PacketStructure {
        ...
        return PacketStructure { id: id, name: self.name.clone(), fields: packet_fields, delimiters: packet_delimiters };
    }
}
