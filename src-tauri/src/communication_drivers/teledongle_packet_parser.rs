...
mod parser_tests {
    ...
    fn test_basic_parsing() {
        ...
        let data = make_teledongle_frame(
            32,
            &[
                0x11, 0xBA, 0x5E, 0xBA, 0x10, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x04, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x1E, 0xAB, 0x11, 0xCA, 0xF2,
            ],
        );
    ...
    fn can_data_be_mistaken_for_delimiters() {
        ...
        let data = make_teledongle_frame(
            32,
            &[
                0x11, 0xBA, 0x5E, 0xBA, 0x10, 0x00, 0x08, 0x00, 0x11, 0xBA, 0x5E, 0xBA,
                0x10, 0x00, 0x08, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x04, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x1E, 0xAB, 0x11, 0xCA, 0x1E, 0xAB, 0x11, 0xCA,
            ],
        );
        packet_parser.push_data(&data, false);
        let parsed = packet_parser
    ...
    fn bad_data_test() {
        ...
        let data = make_teledongle_frame(
            ...
            &[
                ...
                0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x04, 0x00, 0x00,
                0x00, //one too long
                0x00, 0x00, 0x00, 0x00, 0x1E, 0xAB, 0x11, 0xCA, 0x11, 0xBA, 0x5E, 0xBA,
                0x10, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
                0x00, 0x02, 0x00, 0x03, 0x04, 0x00, //one too short
    ...
    fn consecutive_parsing_test() {
        ...
        let data = make_teledongle_frame(
            ...
            &[
                0x11, 0xBA, 0x5E, 0xBA, 0x10, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x04, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x1E, 0xAB, 0x11, 0xCA, 0xBA, 0xBB, 0xE1,
            ],
        ); //garbage data
        let data = data;
        let data2 = make_teledongle_frame(
            ...
            &[
                0x11, 0xBA, 0x5E, 0xBA, 0x10, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x06, 0x00, 0x07, 0x08, //changing variables
    ...
    fn multiple_structures() {
        ...
        let data2 = make_teledongle_frame(
            8,
            &[
                0x01, 0x00, 0x00, 0x00, 0x1A, 0x1A, 0x1A, 0xFA, 0x02, 0x00, 0x00, 0x00,
    ...
    fn same_first_delim() {
        ...
        let data = make_teledongle_frame(
            4,
            &[
                0x11, 0xBA, 0x5E, 0xBA, 0x20, 0x00, 0x08, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,
